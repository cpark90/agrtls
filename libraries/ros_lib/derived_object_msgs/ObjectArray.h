#ifndef _ROS_derived_object_msgs_ObjectArray_h
#define _ROS_derived_object_msgs_ObjectArray_h
...
namespace derived_object_msgs
{
  ...
  class ObjectArray : public ros::Msg
  {
    public:
      ...
      typedef derived_object_msgs::Object _objects_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(objects_lengthT > objects_length)
        this->objects = (derived_object_msgs::Object*)realloc(this->objects, objects_lengthT * sizeof(derived_object_msgs::Object));
      objects_length = objects_lengthT;
      for( uint32_t i = 0; i < objects_length; i++){
      offset += this->st_objects.deserialize(inbuffer + offset);
        memcpy( &(this->objects[i]), &(this->st_objects), sizeof(derived_object_msgs::Object));
      }
     return offset;
    }

    const char * getType(){ return "derived_object_msgs/ObjectArray"; };
    const char * getMD5(){ return "492c83cd255b9a57845d0c197d7977be"; };
