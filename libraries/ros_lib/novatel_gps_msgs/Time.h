...
namespace novatel_gps_msgs
{
  ...
  class Time : public ros::Msg
  {
    public:
      ...
      _offset_type offset;
      typedef float _offset_std_type;
      _offset_std_type offset_std;
      typedef float _utc_offset_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->offset_std);
      offset += serializeAvrFloat64(outbuffer + offset, this->utc_offset);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->offset_std));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->utc_offset));
