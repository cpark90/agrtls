#ifndef _ROS_novatel_gps_msgs_Gpgga_h
#define _ROS_novatel_gps_msgs_Gpgga_h
...
namespace novatel_gps_msgs
{
  ...
  class Gpgga : public ros::Msg
  {
    public:
      ...
      enum { GPS_QUAL_INVALID = 0 };
      enum { GPS_QUAL_SINGLE_POINT = 1 };
      enum { GPS_QUAL_PSEUDORANGE_DIFFERENTIAL = 2 };
      enum { GPS_QUAL_RTK_FIXED_AMBIGUITY_SOLUTION = 4 };
      enum { GPS_QUAL_RTK_FLOATING_AMBIGUITY_SOLUTION = 5 };
      enum { GPS_QUAL_DEAD_RECKONING_MODE = 6 };
      enum { GPS_QUAL_MANUAL_INPUT_MODE = 7 };
      enum { GPS_QUAL_SIMULATION_MODE = 8 };
      enum { GPS_QUAL_WASS = 9 };
    ...
    const char * getType(){ return "novatel_gps_msgs/Gpgga"; };
    const char * getMD5(){ return "bc1ad0f59948d0d18a275b656db48121"; };
