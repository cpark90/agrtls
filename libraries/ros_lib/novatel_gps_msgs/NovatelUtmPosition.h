  ...
  class NovatelUtmPosition : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->lon_zone_number >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->northing);
      offset += serializeAvrFloat64(outbuffer + offset, this->easting);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_lat_zone_letter;
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->northing));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->easting));
