  ...
  class RangeInformation : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 1) = (this->glofreq >> (8 * 1)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->psr);
      union {
        float real;
        uint32_t base;
      } u_psr_std;
      ...
      *(outbuffer + offset + 3) = (u_psr_std.base >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->adr);
      union {
        float real;
        uint32_t base;
      } u_adr_std;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->glofreq);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->psr));
      union {
        float real;
        uint32_t base;
      } u_psr_std;
      ...
      offset += sizeof(this->psr_std);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->adr));
      union {
        float real;
        uint32_t base;
      } u_adr_std;
